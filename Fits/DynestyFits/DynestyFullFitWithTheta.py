...
def prior_transform(u):
  ...
  u_delC1X1, u_delPtc1X1,u_theta_eta = u

  ampT8X8 = 100*u_ampT8X8
  ampC8X8 = 100*u_ampC8X8
  ...
  ampCX1 = 300*u_ampC1X1
  ampPtcX1 = 300*u_ampPtc1X1

  delC1X1 = 2*np.pi*u_delC1X1
  delPtc1X1 = 2*np.pi*u_delPtc1X1
  theta_eta = 2*np.pi*u_theta_eta
